...
try{
    ...
    $conn = new PDO("mysql:host=$servername;dbname=$dbnema;
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <input type="password" id="password" class="form-control" placeholder="Password" name="password" value=""><br>
        <input type="password" id="cfmpassword" class="form-control" placeholder="Confirm Password" name="cfmpassword" value="">
</div>
</div>

<div class="form-group row">
    <label for="address" class="col-md-4 col-md-4 col-form-label text-md-right">Address</label>
    <div class="col-md-8">
